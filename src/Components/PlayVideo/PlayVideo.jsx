  ...
  return (
    <div className='play-video'>
        ...
        <div className="publisher">
          ...
          <button className='glow-on-hover'>Subscribe</button>
        </div>
...
{/* 
          <div className="comment">
            ...
            <div>
              <h3>Mansour Gulzad <span>1 day ago</span></h3>
              <p>I like your channel and the way you provide us vidoes full of fun and joy, I appreciate your hard work, I always enjoy your vidoes and learn from your valuable information, keep up the good work.</p>
              <div className="comment-action">
                <img src={like} alt="" />
                <span>244</span>
                <img src={dislike} alt="" />
